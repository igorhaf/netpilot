...
export class StacksPresetsSeed {
  ...
  private async createLaravelStack(stackRepo, presetRepo): Promise<Stack> {
...
MAIL_FROM_NAME="\${APP_NAME}"`,
  ...
  private async createNextStack(stackRepo, presetRepo): Promise<Stack> {
    // Docker Compose para Next.js
    const dockerCompose = await presetRepo.save({
...
- Contraste adequado de cores`,
  ...
  private async createReactNativeStack(stackRepo, presetRepo): Promise<Stack> {
    // Persona Mobile
    const persona = await presetRepo.save({
...
- Detox para E2E`,
  ...
  private async createSharedPresets(presetRepo): Promise<void> {
