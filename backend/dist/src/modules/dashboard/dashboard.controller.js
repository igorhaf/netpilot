...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obter logs recentes para o dashboard' }),
...
__decorate([
    (0, common_1.Get)('expiring-certificates'),
    (0, swagger_1.ApiOperation)({ summary: 'Obter certificados expirando' }),
    (0, swagger_1.ApiQuery)({ name: 'days', required: false }),
    __param(0, (0, common_1.Query)('days')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], DashboardController.prototype, "getExpiringCertificates", null);
