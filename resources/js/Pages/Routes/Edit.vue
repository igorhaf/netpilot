  ...
  <AppLayout>
    <div class="px-4 py-6 sm:px-0">
      <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Update routing rule configuration for <span class="font-semibold font-mono">{{ route.path_pattern }}</span>.</p>
      </div>
...
const form = reactive({
  domain_id: props.route.domain_id,
  upstream_id: props.route.upstream_id,
  path_pattern: props.route.path_pattern,
  http_method: props.route.http_method,
  priority: props.route.priority || 100,
  timeout: props.route.timeout || 30,
  description: props.route.description || '',
  is_active: props.route.is_active,
  preserve_host: props.route.preserve_host,
  strip_prefix: props.route.strip_prefix
})
...
const submit = () => {
  ...
  router.put(`/routes/${props.route.id}`, form, {
