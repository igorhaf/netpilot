<template>
  <AppLayout>
    <div class="px-4 py-6 sm:px-0">
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Add Upstream</h1>
        <p class="mt-2 text-sm text-gray-600">Create a new backend server configuration with load balancing and health checks.</p>
      </div>
