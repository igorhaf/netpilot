...
echo "   su -s /bin/bash bender -c 'cd /home/deit/code && claude -p --permission-mode bypassPermissions \"what is 2+2\"'"
echo "   su -s /bin/bash marvin -c 'cd /home/deit/code && claude -p --permission-mode bypassPermissions \"what is 2+2\"'"
echo ""
...
echo "     -d '{\"projectPath\": \"/home/deit/code\", \"prompt\": \"liste os arquivos\", \"agent\": \"bender\"}'"
echo ""
